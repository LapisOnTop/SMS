...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2026 at 03:41 PM
...
(4, 'Registrar1', '$2y$10$M2qwIXId1kvN5t0RnBXUKeSylQU.1mOPMmaULHSNRoryWTzUUIwPu', 4, 1, '2026-04-04 20:01:17'),
...
--
ALTER TABLE `subject_preselection`
  MODIFY `preselection_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
CREATE TABLE IF NOT EXISTS `website_contact_submissions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_website_contact_status` (`status`),
  KEY `idx_website_contact_submitted_at` (`submitted_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `website_enrollment_submissions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_website_enrollment_status` (`status`),
  KEY `idx_website_enrollment_program` (`program`),
  KEY `idx_website_enrollment_submitted_at` (`submitted_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
